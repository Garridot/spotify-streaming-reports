...
export const renderMenuProfile = (data) => {
    ...
    `<button><img src="${data["user"]["profile_image_url"]}" height="40" width="40"> ${data["user"]["username"]}</button>
    <ul class="profile-options">
        <li><a href="">Log out <svg style="margin-left: 10px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M377.9 105.9L500.7 228.7c7.2 7.2 11.3 17.1 11.3 27.3s-4.1 20.1-11.3 27.3L377.9 406.1c-6.4 6.4-15 9.9-24 9.9c-18.7 0-33.9-15.2-33.9-33.9l0-62.1-128 0c-17.7 0-32-14.3-32-32l0-64c0-17.7 14.3-32 32-32l128 0 0-62.1c0-18.7 15.2-33.9 33.9-33.9c9 0 17.6 3.6 24 9.9zM160 96L96 96c-17.7 0-32 14.3-32 32l0 256c0 17.7 14.3 32 32 32l64 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-64 0c-53 0-96-43-96-96L0 128C0 75 43 32 96 32l64 0c17.7 0 32 14.3 32 32s-14.3 32-32 32z"/></svg></a></li>
    </ul>`
...
export const renderTopTrackstStats = (data) => {
    ...
    var topPlayed = data["most_played_by_play_count:"];
    ...
    <div class="top-item-modal--tracks">                                                
        <ul>                                                
            <li style="list-style:none;">
                <h3>Your Most Played Track This Week:</h3>
                <h1>${topPlayed[0]["song_name"]} - ${topPlayed[0]["artist_name"]}</h1>                
                <h3>Played Count: <span class="review__highlighted">${topPlayed[0]["played_at"]}</span></h3>              
            </li>               
        </ul> 
        <div class="top-item-modal-image">
            <img src="${topPlayed[0]["image"]}" alt="${topPlayed[0]["album"]}"> 
        </div>
    </div> 
    <hr>
    <div class="model-table">
        ...
        <thead style="text-align:justify;">
            <tr>                             
                ...
                <th>Tracks</th>                  
                <th>Artists</th>                  
                <th style="text-align:end">Played Count</th>   
            </tr>
        </thead>
        <tbody>
        </tbody>
    ...
    for (const [key, value] of Object.entries(topPlayed).slice(1)) {
        ...
        <tr>  
            ...
            <td>${value["song_name"]}</td>         
            <td>${value["artist_name"]}</td>                                
            <td style="text-align:end">${value["played_at"]}</td>                
        </tr>
        `;
...
export const renderTopArtiststStats = (data) => {
    ...
    <div class="top-item-modal--tracks">                                                
        <ul>                                                
            <li style="list-style:none;">
                <h3>Your Most Played Artist This Week:</h3>
                <h1>${topPlayed[0]["artist_name"]}</h1>                
                <h3>Played Count: <span class="review__highlighted">${topPlayed[0]["played_at"]}</span></h3>              
            </li>               
        </ul> 
        <div class="top-item-modal-image">
            <div class="top-item-modal-image-wrapper" style="background:url(${topPlayed[0]["artist_image"]}) center center/cover;"></div>
        </div>
    </div>      
    <hr>
    <div class="model-table">
